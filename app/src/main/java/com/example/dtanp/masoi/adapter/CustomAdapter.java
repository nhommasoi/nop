...
public class CustomAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.txtban.setText(list.get(position).getSophong()+"");
        holder.txttenban.setText(list.get(position).getTenphong()+"");
        holder.txtcuoc.setText(list.get(position).getCuoc()+"");
        holder.txtsonguoi.setText(list.get(position).getSonguoi()+"");
        return view;
    }
}
